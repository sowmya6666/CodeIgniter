...
import comm.studentdetails.StudentRegistartionRq.Students;
import comm.studentdetails.StudentRegistartionRq.Students.Student;
import comm.studentdetails.StudentRegistartionRq.Students.Student.Address;
...
/**
 * This class contains marshal and un marshal Student Object using JAX B
 *
 * @author sowmya
 */
    ...
    public static void main(String args[]) {
        ...
        try {
           ...
           Long l = new Long(8220568318L);
            ...
            Student student = new StudentRegistartionRq.Students.Student();
            List<Address> addList = new ArrayList<Address>();
            Address address1 = new Student.Address();
            ...
            Address address2 = new Student.Address();
            ...
            for (Student st : stReq.getStudents().getStudent()) {
                studentId = st.getId();
